...
export default function LookInputSection({ outfit, onOutfitChange, sneakers }) {
  ...
  return (
    <div className="space-y-3">
      ...
      {method === 'manual' && <GarmentSelector outfit={outfit} onOutfitChange={onOutfitChange} sneakers={sneakers} />}
    </div>
  )
}
